 ...
 *     description: Retrieves all user-generated posts from the Firestore "posts" collection. If cached data exists, it is returned for faster performance.
 *     tags:
 *       - Posts
 *     responses:
 *       200:
 *         description: A list of user posts with user profile pictures and comments
 *         content:
 *           application/json:
 *             schema:
 *               type: object
